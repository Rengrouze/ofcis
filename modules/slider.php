        ...
        <div id="rev_slider_1" class="rev_slider" style="display: none">
            ...
            <ul>
                <li data-transition="random" data-title="Slide Title" data-param1="Additional Text"
                    data-thumb="images/ofcis/sst_ofcis.jpg">
                    <!-- SLIDE'S MAIN BACKGROUND IMAGE -->
                    <img src="images/ofcis/sst_ofcis.jpg" alt="Sky" class="rev-slidebg" />
                    <!--<img src="images/slide06.jpg" alt="Sky" class="rev-slidebg">-->
                    <!-- BEGIN BASIC TEXT LAYER -->
                    <!-- LAYER NR. 2 -->
                    <div class="tp-caption sfr font-extra-bold tp-resizeme letter-space-4"
                        data-x="['left', 'center', 'center', 'center']" data-hoffset="0" data-y="center"
                        data-voffset="-70"
                ...
                ">
                    ...
                    <!-- LAYER NR. 2 -->
                    <div class="tp-caption sfr font-extra-bold tp-resizeme letter-space-4" data-x="left"
                ...
                ">
                    ...
                    <!-- LAYER NR. 3 -->
                    <div class="tp-caption font-lora sfb tp-resizeme letter-space-5" data-x="left" data-hoffset="0"
                ...
                ">
                    ...
                    <div class="tp-caption lfb tp-resizeme" data-x="left" data-hoffset="0" data-y="center"
                        ...
                        style="z-index: 8">
                        <a href="#." class="el-btn-regular slider-btn-left">View Courses</a>
                        <a href="#." class="el-btn-regular">Purchase Now</a>
                    </div>
                </li>
                <li data-transition="random" data-title="Slide Title" data-param1="Additional Text"
                    data-thumb="images/ofcis/securite_incendie_ofcis.jpg">
                    <!-- SLIDE'S MAIN BACKGROUND IMAGE -->
                    <img src="images/ofcis/securite_incendie_ofcis.jpg" alt="Sky" class="rev-slidebg" />
                    <!-- BEGIN BASIC TEXT LAYER -->
                    <!-- LAYER NR. 2 -->
                    <div class="tp-caption sfr font-extra-bold tp-resizeme letter-space-4" data-x="left"
                        data-hoffset="0" data-y="center" data-voffset="-70"
                        data-frames='[{"delay":0,"speed":3000,"frame":"0","from":"x:[175%];y:0px;z:0;rX:0;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;opacity:1;","mask":"x:[-100%];y:0;s:inherit;e:inherit;","to":"o:1;","ease":"Power3.easeOut"},{"delay":"wait","speed":300,"frame":"999","to":"auto:auto;","ease":"Power3.easeInOut"}]'
                        style="
                  z-index: 6;
                  font-size: 60px;
